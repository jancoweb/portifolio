      ...
      <div className="project-list">
        ...
        <div className="project right">
          <div className="project-text-content">
            ...
            <p className="project-text">
              I started this project to pratice ReactJS and third party API consumption. In this case, this application allows you to find a specific Rick and Morty character by his name, search a random character or even see the full cast (826 characters).
            </p>
